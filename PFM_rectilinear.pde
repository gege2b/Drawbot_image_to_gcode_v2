///////////////////////////////////////////////////////////////////////////////////////////////////////
// This path finding module makes some random rectangles. Heavily based on PFM_squares
///////////////////////////////////////////////////////////////////////////////////////////////////////

class PFM_rectilinear implements pfm {
  ...
  int          start_line_length = 3;           // Reasonable values:  3 through 100
  int          max_line_length = 100;
  int          line_length = start_line_length;
...
//    image_boarder("b6.png", 0, 0);
  ...
  private void find_squiggle() {
    ...
    for (int s = 0; s < squiggle_length; s++) {
      if (line_length <= max_line_length) { line_length += squiggle_count; } else { line_length = start_line_length; }
      find_darkest_neighbor(x, y);
